...
browser.addheaders=[('User-agent', 'Mozilla/5.0 (platform; rv:geckoversion) Gecko/geckotrail Firefox/firefoxversion')]
...
for page in range(1,pagesToGet+1):
    ...
    url='http://www.theverge.com/users/chrisziegler/posts/'+str(page)
